...
- Optional pacing aids (toggles in Settings): rare and invented words linger by frequency (wordfreq data, attributed in `internal/vocab/data`), with auto-off for non-English books
...
- Follow System, Dark, or Light appearance (system default; explicit choices apply on restart); adjustable reader font size and a searchable system font picker for the reader typeface (RSVP word and context pane; TrueType, OpenType, and collections)
...
| ⌥← / ⌥→ (Option+arrows) | Back / forward 25 words |
